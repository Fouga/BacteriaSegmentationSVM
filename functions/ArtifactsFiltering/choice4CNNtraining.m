...
%             Im = imcrop(im,[rect2(1)-shift/2 rect2(2)-shift/2 rect2(3)+shift rect2(4)+shift]);
        ...
        RGBIM  = cat(3,imadjust(im(:,:,1),[0 0.03],[]),imadjust(im(:,:,2),[0 0.015],[]),imadjust(im(:,:,3),[0 0.015],[]));
        shift2 = 200;
...
%             imwrite(IM,fullfile(save_dir_bact, name2));
        name3  = sprintf('Frame_%i_optical_0%i_Bacterium_%i_noRed.tif',counter,optical,i);
